...
export default function Index() {
  ...
  const categories = [
    ...
    { name: "Breads & Batter", icon: "🍞", color: "bg-orange-100" },
    { name: "Oil & Ghee", icon: "🛢️", color: "bg-yellow-100" },
    { name: "Rice & Pulses", icon: "���", color: "bg-amber-100" },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-4">
            {categories.map((category) => (
              <Link key={category.name} to="/categories" className="group">
      ...
      {/* Footer */}
      <footer className="bg-fresh-700 text-white py-6 md:py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                  <Leaf className="w-5 h-5 text-fresh-500" />
                </div>
                <h5 className="text-xl font-bold">FreshMart</h5>
              </div>
              <p className="text-fresh-100">
                Your trusted partner for fresh groceries and daily essentials.
              </p>
            </div>

            <div>
              <h6 className="font-semibold mb-3 md:mb-4 text-sm md:text-base">
                Quick Links
              </h6>
              <ul className="space-y-1 md:space-y-2 text-fresh-100">
                <li>
                  <Link
                    to="/about"
                    className="hover:text-white text-sm md:text-base transition-colors"
                  >
                    About Us
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-1 md:space-y-2 text-fresh-100">
                <li>
                  <Link to="/categories/dairy" className="hover:text-white">
                    Dairy & Milk
                  </Link>
                </li>
                <li>
                  <Link to="/categories/fruits" className="hover:text-white">
                    Fruits & Vegetables
                  </Link>
                </li>
                <li>
                  <Link to="/categories/bakery" className="hover:text-white">
                    Bakery
                  </Link>
                </li>
                <li>
                  <Link to="/categories/beverages" className="hover:text-white">
                    Beverages
                  </Link>
                </li>
              </ul>
            ...
            <div>
              <h6 className="font-semibold mb-3 md:mb-4 text-sm md:text-base">
                {isAuthenticated ? "Your Account" : "Download App"}
              </h6>
              <p className="text-fresh-100 mb-3 md:mb-4 text-sm md:text-base">
                {isAuthenticated
                  ? `Welcome back, ${user?.name.split(" ")[0]}!`
                  : "Get the best deals on our mobile app"}
              </p>
              <div className="space-y-2">
                ...
                <a
                  href="https://apps.apple.com/app/freshmart"
                  target="_blank"
                ...
                <a
                  href="https://play.google.com/store/apps/details?id=com.freshmart"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block"
                >
          ...
          <div className="border-t border-fresh-600 mt-6 md:mt-8 pt-6 md:pt-8 text-center text-fresh-100">
